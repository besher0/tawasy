...
describe('buildOrderItemDisplay', () => {
  it('orders mold details for production reading', () => {
    ...
    expect(display).toEqual({
      ...
      lines: [
        'عدد الأشخاص: 12',
        'لون القالب من الداخل: أبيض',
        'نوع القالب: شوكولا',
        'اللون الخارجي للقالب: زهري',
        'نوع الحشوة: فستق',
        'شكل القالب: دائري',
        'الفلين: مع فلين',
        'التجهيز الخارجي: تلبيس',
        'الملاحظات والإضافات الأخرى: كتابة اسم',
      ],
    });
  });
  ...
  it('orders pieces details for production reading', () => {
    ...
    expect(display).toEqual({
      ...
      lines: [
        ...
        'عدد الطبقات: 2',
        'نوع القطع: كب كيك',
        'هل يوجد فوقها شيء: نعم',
        'الملاحظات والإضافات الأخرى: لون أزرق',
      ],
    });
  });
});
